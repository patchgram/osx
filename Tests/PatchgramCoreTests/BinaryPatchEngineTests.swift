...
final class BinaryPatchEngineTests: XCTestCase {
    ...
    func testPatchesJSONRoundTripsToBuiltInRules() throws {
        ...
        XCTAssertEqual(BinaryPatchRuleCatalog.rules.count, 28)
    ...
    func testPatchBundleVerifierAcceptsSignedBundleAndRejectsTampering() throws {
        ...
        let signature = try XCTUnwrap(Data(base64Encoded: "aGLCDKKahJb7ai2ukasO3eXSMq9kyJHdRnyYp2LthNyrTrPrI8QJqNErUIXh+055dzoVWOpdnCtjlb3wbqfECg=="))
        ...
        XCTAssertEqual(manifest.bundleVersion, 11)
    ...
    func testCatalogLoaderAppliesCachedBundleOverride() throws {
        ...
        XCTAssertEqual(PatchCatalogLoader.load(provider: provider).count, 28)
