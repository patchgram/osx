...
public enum BinaryPatchRuleDefinitions {
    ...
    private static let rawBuiltInRules: [BinaryPatchRule] = [
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Injects Patchgram.dylib into Telegram via a DYLD_INSERT_LIBRARIES launcher — the base hook every runtime patch loads through.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Rains a chosen image or animated sticker over an open profile, drawn natively by the dylib.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Logs every MTProto request and response (fully decoded TL, timestamped) to log files next to Telegram.",
        ...
        // Hide messages from blocklisted users, at runtime. The dylib captures your blocked user ids from
        // contacts.blocked / contacts.blockedSlice responses and removes every message whose sender is
        // blocked from messages.getHistory responses. Runtime flag only — no bytes patched.
        BinaryPatchRule(
            id: "binary.messages.hide_blocked",
            title: "Hide blocked users' messages",
            methodName: "messages.getHistory + contacts.getBlocked",
            constructorId: "hide-blocked",
            kind: .runtimeMemory,
            summary: "Hides messages from people who are in your blocklist (blocked users).",
            disabledBehavior: "Stops hiding blocked users' messages; re-opening the chat shows them again.",
            riskNote: "Local display-only filter: it removes blocked users' messages from the history the client shows and changes nothing server-side.",
            supportedBuildNote: "Uses the dylib's existing send/receive hooks; independent of byte-level signatures, so it is resilient across Telegram Desktop builds.",
            replacements: [
                BinaryReplacement(
                    id: "messages.hide_blocked.runtime_flag",
                    originalHex: "",
                    patchedHex: ""
                )
            ],
        ...
        BinaryPatchRule(
            ...
            summary: "Keeps your account offline by forcing the account.updateStatus request to offline.",
        ...
        BinaryPatchRule(
            ...
            kind: .poisonConstructor,
            summary: "Groups message-privacy subpatches: typing, read receipts, local drafts, scheduled send, custom Fact Check, copy/save protect, and TTL.",
        ...
        BinaryPatchRule(
            ...
            kind: .forceSerializedBool,
            summary: "Opens hidden/external links directly, without Telegram's confirmation warning.",
        ...
        BinaryPatchRule(
            ...
            kind: .forceSerializedBool,
            summary: "Stops sending the phone-privacy exception when you add a contact.",
        ...
        BinaryPatchRule(
            ...
            kind: .unlockLimit,
            summary: "Raises the local account limit from 6 to 999.",
        ...
        BinaryPatchRule(
            ...
            summary: "Shows bot inline-button callback data locally on hover/copy.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Disables Premium, Stars, TON, Gifts, boosts and related monetization UI/requests at runtime.",
        ...
        BinaryPatchRule(
            ...
            kind: .localPremium,
            summary: "Makes the client treat Premium as locally available for UI gates.",
        ...
        BinaryPatchRule(
            ...
            kind: .accountFreeze,
            summary: "Shows your account as frozen locally by injecting freeze dates and an appeal URL into help.appConfig.",
        ...
        BinaryPatchRule(
            ...
            summary: "Locally overrides your displayed TON balance.",
        ...
        BinaryPatchRule(
            ...
            constructorId: "payments.getStarsTransactions#69da4557 / payments.StarsStatus.balance",
            kind: .overrideResponseValue,
            summary: "Locally overrides your displayed Stars balance.",
        ...
        BinaryPatchRule(
            ...
            kind: .visualBadge,
            summary: "Adds a local Verified, Scam, or Fake badge to selected peers.",
        ...
        BinaryPatchRule(
            ...
            summary: "Adds local bot-verification details to selected peers.",
        ...
        BinaryPatchRule(
            ...
            summary: "Overrides the local Stars level/rating for selected users.",
        ...
        BinaryPatchRule(
            ...
            kind: .hideSelfPhone,
            summary: "Hides the phone row in your own profile.",
        ...
        BinaryPatchRule(
            ...
            summary: "Locally replaces your own phone number and displayed user id.",
        ...
        BinaryPatchRule(
            ...
            summary: "Locally attaches a channel to your own profile by id.",
        ...
        BinaryPatchRule(
            ...
            kind: .fragmentPhone,
            summary: "Makes your phone look collectible (Fragment) with local collectibleInfo values.",
        ...
        BinaryPatchRule(
            ...
            kind: .starGiftSpoof,
            summary: "Rewrites the star gifts shown on a profile — sender, date, gift id, Stars price and more.",
        ...
        BinaryPatchRule(
            ...
            summary: "Shows a profile's gift as an upgraded (unique) gift with a title, number, model, symbol and backdrop you choose.",
        ...
        BinaryPatchRule(
            ...
            summary: "Makes a spoofed gift transferable and fakes the transfer with a local service message. Requires Spoof profile unique gifts.",
        ...
        BinaryPatchRule(
            ...
            summary: "Adds extra star gifts to the gift-purchase menu locally.",
        ...
        BinaryPatchRule(
            ...
            summary: "Replaces the username list shown on your own profile, with local Fragment collectible info.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Stops Premium sticker/effect animations locally.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Shows spoiler-marked photos and videos normally.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Disables local sensitive-content blur.",
        ...
        BinaryPatchRule(
            ...
            kind: .runtimeMemory,
            summary: "Raises the Recent stickers panel limit from 20 to 200.",
        ...
        BinaryPatchRule(
            ...
            kind: .poisonConstructor,
            summary: "Hides stories locally and blocks story fetch/read/view requests.",
